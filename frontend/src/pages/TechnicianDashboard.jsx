...
import { 
  ClipboardList, Plus, Bell, Clock, 
  CheckCircle, AlertCircle, X, Loader2,
  MapPin, Tag, ChevronRight, Search,
  Paperclip, MessageSquare, Filter
} from 'lucide-react';
        ...
        <div className="mb-10 flex flex-col sm:flex-row sm:items-end justify-between gap-4">
          <div>
            ...
            <p className="text-gray-500 font-medium text-lg">
              Report incidents and track your maintenance requests.
            </p>
          </div>
          <button
        ...
        {!loading && tickets.length > 0 && (
          <div className="bg-[#222222] rounded-[2.5rem] p-8 md:p-10 text-white overflow-hidden relative mt-10">
            <div className="relative z-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div>
                <h2 className="text-2xl font-bold mb-1">Need to report something?</h2>
                <p className="text-gray-400 text-sm max-w-md">
                  Report any facility issues or incidents and we'll get someone on it right away.
                </p>
              </div>
              <button
                onClick={() => setShowCreateModal(true)}
